      ...
      >
        ...
        <div className={styles.department}>
          ...
          <div className={styles.subdepartment}>
            <span>
              <Link href="/department/news/campaign-coverage">Campaign Coverage</Link>
            </span>
          </div>
        </div>
        ...
        <div className={styles.department}>
          ...
          <div className={styles.subdepartment}>
            <span>
              <Link href="/department/opinions/staff-editorials">Staff Editorials</Link>
            </span>
          </div>
        </div>
        ...
        <div className={styles.department}>
          ...
          <div className={styles.subdepartment}>
            <span>
              <Link href="/department/humor/disrespectator">Disrespectator</Link>
            </span>
            <span>
        ...
        <div className={styles.department}>
          ...
          <div className={styles.subdepartment}>
            <span>
              <Link href="/department/sports/professional-sports">Professional Sports</Link>
            </span>
            <span>
              <Link href="/department/sports/sports-at-stuyvesant">Sports At Stuy</Link>
            </span>
          </div>
        </div>

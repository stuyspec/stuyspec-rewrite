        ...
        <div id={styles.socialsBar}>
          ...
          <div id={styles.mediaButtons}>
            <Link
              ...
              passHref
            >
              <i className="bi bi-spotify" id={styles.mediaButton} />
            </Link>
            <Link href="https://www.facebook.com/stuyspectator" passHref>
              <i className="bi bi-facebook" id={styles.mediaButton} />
            </Link>
            <Link href="https://www.instagram.com/stuyspectator/" passHref>
              <i className="bi bi-instagram" id={styles.mediaButton} />
            </Link>
            <Link
              href="https://www.linkedin.com/company/the-stuyvesant-spectator"
              passHref
            >
              <i className="bi bi-linkedin" id={styles.mediaButton} />
            </Link>
            <Link href="https://github.com/stuyspec" passHref>
              <i className="bi bi-github" id={styles.mediaButton} />
            </Link>
          </div>
        </div>
        ...
        <div id={styles.grid}>
          <div id={styles.column}>
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/news/campaign-coverage">Campaign Coverage</Link>
              </p>
              <p id={styles.subdepartment}>
                <Link href="/news/1031-terror-attack">10/31 Terror Attack</Link>
              </p>
              <p id={styles.subdepartment}>
                <Link href="/news/black-lives-matter">Black Lives Matter</Link>
              </p>
            </div>
            <div id={styles.cell}>
              <h3 id={styles.department}>
            ...
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/opinions/blacklivesmatter">#BlackLivesMatter</Link>
              </p>
              <p id={styles.subdepartment}>
                <Link href="/opinions/staff-editorials">Staff Editorials</Link>
              </p>
              <p id={styles.subdepartment}>
          ...
          <div id={styles.column}>
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/science/at-stuy">Science at Stuy</Link>
              </p>
              <p id={styles.subdepartment}>
            ...
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/humor/disrespectator">Disrespectator</Link>
              </p>
              <p id={styles.subdepartment}>
            ...
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/sports/professional">Professional Sports</Link>
              </p>
              <p id={styles.subdepartment}>
                <Link href="/sports/at-stuy">Sports At Stuy</Link>
              </p>
            </div>
          </div>
          <div id={styles.column}>
          ...
          <div id={styles.column}>
            ...
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/spec-plus/quarenzine">Quarenzine</Link>
              </p>
              <p id={styles.subdepartment}>
                <Link href="/spec-plus/undercurrents">Undercurrents</Link>
              </p>
            </div>
            <div id={styles.cell}>
              <h3 id={styles.department}>

        ...
        <div id={styles.grid}>
          ...
          <div id={styles.column}>
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/department/science/at-stuy">Science at Stuy</Link>
              </p>
              <p id={styles.subdepartment}>
            ...
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/department/sports/at-stuy">Sports At Stuy</Link>
              </p>
            </div>
          </div>
          <div id={styles.column}>
          ...
          <div id={styles.column}>
            ...
            <div id={styles.cell}>
              ...
              <p id={styles.subdepartment}>
                <Link href="/department/spec-plus/quaranzine">Quaranzine</Link>
              </p>
              <p id={styles.subdepartment}>

...
const RecruitmentPage = () => {
  const departments: Array<{
    ...
    {
      department: "Humor",
      description: "Do you want to lowkey rant about your life and roast everything? Would you like to have a personality glow up? Do you want to join a low commitment and fun Spec department? Join Spec Humor! We write funny and satirical pieces for The Spec and unlike other departments, everything we publish is libel and slander which means that you'll be in control of what everyone says!",
      applicationForm: "",
      applicationDueDate: "",
    },
    {
          ...
          >
            {departments.map((department, key) => (
              ...
              >
                ...
                <p style={{textAlign: "justify"}}>{department.description}</p>
              </div>
            ))}
          </div>
        </div>

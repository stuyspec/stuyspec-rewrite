  ...
  return (
    <>
      ...
      <main id={styles.main}>
        ...
        <section id={styles.departmentsContainer}>
          <div id={styles.departmentOptions}>
            {departments.map((department, i) => (
              <button
                key={i}
                id={styles.departmentOption}
                className={
                  department.department === active.department
                    ? styles.active
                    : ""
                }
                onClick={() => setActive(departments[i])}
              >
          ...
          <div id={styles.departmentInfo}>
            <div className={styles.infoTitleContainer}>
              <span className={styles.infoTitlePrecursor}>Join the...</span>{" "}
              <h3 className={styles.infoTitle}>
                ...
                Spectator's{" "}
                <span className={styles.selectedDepartment}>
                  {active.department}
                </span>{" "}
                Department!
              </h3>
            </div>
            <span className={styles.infoDescription}>{active.description}</span>
            <div className={styles.infoForms}>
              <a href={active.applicationForm} className={styles.link}>
                Apply Now!
              </a>
              <span>

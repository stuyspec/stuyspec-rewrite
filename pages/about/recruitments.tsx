...
function RecruitmentPage() {
	...
	return (
		<>
			...
			<main id={styles.main}>
				<h1>Recruitments</h1>
				<p className={styles.note}>Note: Spring 2024 recruitments will be held in the cafeteria on Wednesday, March 27th and Thursday, March 28th. <br />Application forms for Spring 2024 recruitments are coming out soon!</p>

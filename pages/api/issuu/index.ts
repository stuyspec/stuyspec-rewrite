...
async function getImages() {
  const response = await fetch("https://issuu.com/call/profile/v1/documents/stuyspectator?offset=0&limit=25", {
            "headers": {
              "accept": "*/*",
        ...
        const getImages = await fetch(`https://reader3.isu.pub/stuyspectator/${uri}/reader3_4.json`, {
        ...
        const images : String[] = [json2.document.pages[0].imageUri, json2.document.pages[pagesLength].imageUri];

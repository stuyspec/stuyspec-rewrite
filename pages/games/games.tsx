...
Play();
  ...
  <div className="center">
    ...
    <div className="line">
      <input className="word" type="text" value="Pen" />
      <input className="clue" value="A writing utensil for written portions in the regents" />
    </div>

    <div className="line">
      <input className="word" type="text" value="Pencil" />
      <input className="clue" value="A writing utensil for filling out Scantrons" />
    </div>

    <div className="line">
      <input className="word" type="text" value="stapler"/>
      <input className="clue" value="For connecting late worksheets together" />
    </div>
    <div className="line">
      <input className="word" type="text" value="bag"/>
      <input className="clue" value="Where all students put their belongings" />
    </div>
    <div className="line">
      <input className="word" type="text" value="paper"/>
      <input className="clue" value="A rectangular white slip for writing" />
    </div>
    <div className="line">
      <input className="word" type="text" value="ruler"/>
      <input className="clue" value="For measuring the length of things" />
    </div>
    <div className="line">
      <input className="word" type="text" value="glue"/>
      <input className="clue" value="For sticking objects together" />
    </div>
    <div className="line">
      <input className="word" type="text" value="eraser"/>
      <input className="clue" value="A utensil used to remove mistakes" />
    </div>
    <div className="line">
